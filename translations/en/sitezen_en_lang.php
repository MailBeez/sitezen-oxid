...
$aLang = [
    ...
    // Module settings
    'SHOP_MODULE_GROUP_sitezen_settings' => 'Webhook Settings',
    'SHOP_MODULE_sWebhookToken'          => 'Webhook Token',
    'HELP_SHOP_MODULE_sWebhookToken'     => 'Enter a secure token that will be used to authenticate webhook requests.',
];
